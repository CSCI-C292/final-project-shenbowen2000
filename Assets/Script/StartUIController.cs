...
public class StartUIController : MonoBehaviour
{
    ...
    void Awake()
    {
        lastText.text = "Last game：\n Length: " + PlayerPrefs.GetInt("lastl", 0) + "\n Score" + PlayerPrefs.GetInt("lasts: ", 0);
        bestText.text = "Best game：\n Length: " + PlayerPrefs.GetInt("bestl", 0) + "\n Score" + PlayerPrefs.GetInt("bests: ", 0);
    }
